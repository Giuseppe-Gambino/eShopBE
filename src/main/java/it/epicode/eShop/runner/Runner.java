...
public class Runner implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        product1.getPriceHistory().put(LocalDate.now(), new BigDecimal("150.00"));
        ...
        product2.getPriceHistory().put(LocalDate.now(), new BigDecimal("80.00"));
        ...
        product3.setPrice(new BigDecimal("90.00"));
        ...
        product3.getPriceHistory().put(LocalDate.now(), new BigDecimal("90.00"));
        ...
        product4.getPriceHistory().put(LocalDate.now(), new BigDecimal("200.00"));
        ...
        product5.getPriceHistory().put(LocalDate.now(), new BigDecimal("30.00"));
        ...
        product6.setPrice(new BigDecimal("60.00"));
        ...
        product6.getPriceHistory().put(LocalDate.now(), new BigDecimal("60.00"));
        ...
        product7.setPrice(new BigDecimal("130.00"));
        ...
        product7.getPriceHistory().put(LocalDate.now(), new BigDecimal("130.00"));
        ...
        product8.setPrice(new BigDecimal("130.00"));
        product8.setImageUrls(Arrays.asList("https://example.com/saturn-keyboard.jpg","https://example.com/saturn-keyboard.jpg"));
        product8.setReseller(appUser);
        product8.setCategory(categorySvc.findById(9L));
        product8.setCreatedAt(LocalDate.now());
        product8.getPriceHistory().put(LocalDate.now(), new BigDecimal("130.00"));
        ...
        product9.setPrice(new BigDecimal("70.00"));
        ...
        product9.getPriceHistory().put(LocalDate.now(), new BigDecimal("70.00"));
        ...
        product10.setPrice(new BigDecimal("40.00"));
        ...
        product10.getPriceHistory().put(LocalDate.now(), new BigDecimal("40.00"));
